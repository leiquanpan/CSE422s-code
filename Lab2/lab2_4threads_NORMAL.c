...
//     	printf("the value 1 is %d\n",param.sched_priority);
        sched_state_1 = pthread_setschedparam(thread[core_num*4],policy,&paramone);
        if(sched_state_1)
        {
...
//	param.sched_priority = midpriority - 1;
        ...
        sched_state_2 = pthread_setschedparam(thread[core_num*4+1],policy,&paramone);
        if(sched_state_2)
        {
...
//      printf("the value 1 is %d\n",param.sched_priority);
	//param.sched_priority = midpriority + 1;
        sched_state_3 = pthread_setschedparam(thread[core_num*4+2],policy,&paramtwo);
        if(sched_state_3)
        {
            fprintf(stderr,"Error - pthread_setschedparam(thread1) return code: %d\n",sched_state_3);
        }
...
//      printf("the value 1 is %d\n",param.sched_priority);
	//param.sched_priority = midpriority + 2;
        sched_state_4 = pthread_setschedparam(thread[core_num*4+3],policy,&paramtwo);
        if(sched_state_4)
        {
            fprintf(stderr,"Error - pthread_setschedparam(thread1) return code: %d\n",sched_state_4);
        }
